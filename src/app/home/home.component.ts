...
@Component({
  ...
  imports: [MenuTileComponent, SignInComponent],
  standalone: true,
})
export class HomeComponent {
  ...
  readonly menus = [
    ...
    },
    {
      ...
      description:
        "Codez un algorithme pour déterminer la solution à un problème, en utilisant votre éditeur de code préféré, puis entrez votre réponse à l'écran et vérifiez si c'est bien la solution.",
      url: '/exercices',
    },
    {
